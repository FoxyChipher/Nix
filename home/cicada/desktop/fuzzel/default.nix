    ...
    users."cicada" = { config, pkgs, lib, ... }: {
      programs.fuzzel = {
        ...
        settings = {
          ...
          key-bindings = {
            # "Control+Enter" = "run-command";
            # "Control+Shift+Enter" = "run-command-as-root";
            # "Control+Tab" = "switch-to-next-tab";
            # "Control+Shift+Tab" = "switch-to-previous-tab";
            # "Control+n" = "select-next-item";
            # "Control+p" = "select-previous-item";
            # "Control+j" = "select-next-item";
            # "Control+k" = "select-previous-item";};
          };
        };
      };
    };
